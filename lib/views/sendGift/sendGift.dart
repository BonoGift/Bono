...
class _SendGiftPageState extends State<SendGiftPage> {
  ...
  Widget _getSendGiftWidget(
    BuyProvider pro,
    DateFormat form,
    WooCommerceMarketPlaceProvider wcmp,
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          pro.userName != null ? _getSelectedUserWidget(pro, form, wcmp) : _getSelectUserWidget(context),
          const SizedBox(height: 4),
          pro.userName == null ? _getUserListWidget(proChat, context, pro, wcmp) : const SizedBox.shrink(),
          const SizedBox(height: 20),
          pro.userName != null ? _getDeliveryLocationWidget(pro) : const SizedBox.shrink(),
  ...
  Widget _getSelectedUserWidget(BuyProvider pro, DateFormat form, WooCommerceMarketPlaceProvider wcmp) {
    return Padding(
  ...
  Widget _getSelectUserWidget(BuildContext context) {
    return Padding(
  ...
  Widget _getDeliveryLocationWidget(BuyProvider pro) {
    return Container(
